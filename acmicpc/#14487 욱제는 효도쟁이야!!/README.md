# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/4.svg" class="solvedac-tier"> [욱제는 효도쟁이야!!](https://www.acmicpc.net/problem/14487) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|61983070|per_ardua_ad_astra|맞았습니다!! |36220KB|60ms|Python 3|138B|
