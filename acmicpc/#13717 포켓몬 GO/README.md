# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/6.svg" class="solvedac-tier"> [포켓몬 GO](https://www.acmicpc.net/problem/13717) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|62085303|per_ardua_ad_astra|맞았습니다!! |31388KB|44ms|Python 3|775B|
