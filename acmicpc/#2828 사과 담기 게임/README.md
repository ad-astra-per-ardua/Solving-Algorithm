# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/6.svg" class="solvedac-tier"> [사과 담기 게임](https://www.acmicpc.net/problem/2828) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|62084148|per_ardua_ad_astra|맞았습니다!! |34128KB|60ms|Python 3|474B|
